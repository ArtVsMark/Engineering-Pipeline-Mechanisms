...
def still_coming(name: str, mine: dict[str, str] | None) -> bool:
    """Объявлен ли этот джоб СВОИМ прогоном и ещё не завершён.
    ...
    *,
    ...
    for name in required:
        ...
        if not live:
            ...
            #
            # Дыры это не открывает: ждём мы только объявленный СВОИМ прогоном
            # джоб. Отменённая запись имени, которого в своём прогоне нет,
