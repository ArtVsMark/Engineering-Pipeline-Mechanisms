...
20–21.09.2026 гейт `check_rule_links` отверг ВОСЕМЬ выдуманных слагов, среди
них `155-an-unused-stub-drifts` вместо `a-template-you-dont-use-drifts` и
полностью несуществующее `104-a-refusal-names-the-way-out`.
...
формат, типы, восемнадцать проверок дерева. За смену это восемь лишних циклов
