...
#: ключ `findings` — находки каталога о НАШЕМ ответе. Разрез их не читает, и
#: это названная дыра, а не молчание: предмет у неё другой (не «чем держится
#: семья», а «что каталог нашёл у нас»), и адресат ей нужен свой (142).
READS_SCHEMA: Final = "1.3"
