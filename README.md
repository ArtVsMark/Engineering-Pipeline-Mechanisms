...
Проект в начале первого этапа. **Написан договор, механизмов ещё нет** — ни
одного прогона, ни одного гейта. Названо это здесь потому, что отсутствующий
механизм и молчащий механизм снаружи неотличимы
([046](https://github.com/ArtVsMark/Engineering-Incidents-Playbook/blob/main/rules/ru/046-name-the-gaps-do-not-level-them.md)).

Значков состояния на витрине нет по той же причине: значок, которому нечего
показывать, читается как «всё в порядке». Появятся вместе с прогонами.
