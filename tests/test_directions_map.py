"""Карта направлений против правила 082: полнота, форма записи и стык с ролями.

Форма ПРОФИЛЯ роли — в `tests/test_roles.py`: карта отвечает «какой вопрос и
задан ли он», файл ролей — «кем и как» (#767).
...
MAP: Final = ROOT / paths.DIRECTIONS
#: Файл ролей: состав, из которого исход карты называет владельца (#767).
