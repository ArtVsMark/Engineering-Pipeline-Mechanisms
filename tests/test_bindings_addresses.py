...
#: Ссылка на НОМЕР шага дорожной карты. Номеров в ней больше нет: карта ведётся
#: этапами, а перечень отложенного живёт в задаче. Рукописный номер в чужом
#: документе — классическое протухание
#: ([005](https://github.com/ArtVsMark/Engineering-Incidents-Playbook/blob/main/rules/ru/005-hand-written-numbers-rot.md)).
ROADMAP_STEP: Final = re.compile(r"шаг\w*\s+\d+\s+в\s+docs/roadmap")


def test_no_answer_points_at_a_numbered_roadmap_step() -> None:
    """Условие, названное номером шага дорожной карты, протухает молча.

    ЗАМЕР 16.09.2026: так и вышло. Три ответа — 076, 112 и 194 — называли
    условием «правило вступит вместе с пакетом (шаг 9 в `docs/roadmap.md`)».
    Пакет появился 15.09.2026, то есть условие НАСТУПИЛО, а шага с номером 9 в
    карте к тому времени не было вовсе: она ведётся этапами. Ни то, ни другое
    не заметил никто — нашёл владелец вопросом о неприменимых.
    ...
    assert not rot, (
        f"ответы ссылаются на номер шага дорожной карты: {rot}. Номеров в ней нет — "
        "условие надо назвать событием, видимым в дереве"
    )
