...
#: Имя файла, названного ответом. ВИДОВ ПЯТЬ, А НЕ ДВА, и это замер, а не вкус:
...
#: или разбор, и ответ рассохся бы молча. Замер того дня: имён `.json` названо
#: 15, `.md` — 21, `.txt` — 1; из них вне дерева трое, и все трое объявлены ниже
#: с причиной.
