...
Карта направлений (`docs/dev/directions.md`) называет вопрос и его владельца; файл
ролей (`docs/agent/roles.md`) — кто этот владелец и как он спрашивает. Разведено по
